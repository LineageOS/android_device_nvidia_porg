...
TEGRAFLASH_PATH := ../../../../vendor/nvidia/common/tegraflash
T210_PATH       := ../../../../vendor/nvidia/t210/tegraflash
SIGN_PATH       := ../../../../$(BCT_PATH)
...
$(INSTALLED_BOOTIMAGE_TARGET): $(MKBOOTIMG) $(INTERNAL_BOOTIMAGE_FILES) $(BOOTIMAGE_EXTRA_DEPS)
	...
	$(hide) cp $(BCT_PATH)/P3448_A00_lpddr4_204Mhz_P987.cfg $(dir $@)/P3448_A00_lpddr4_204Mhz_P987.cfg
	$(hide) cp $(dir $@)/$(DTB_PATH)/tegra210-p3448-0000-p3449-0000-*-android-devkit.dtb $(dir $@)/
	$(hide) cd $(dir $@); PYTHONDONTWRITEBYTECODE=1 $(TEGRAFLASH_PATH)/tegraflash.py --chip 0x21 --applet $(T210_PATH)/nvtboot_recovery.bin --bct P3448_A00_lpddr4_204Mhz_P987.cfg --cfg $(SIGN_PATH)/signboot.xml --cmd "sign"
...
$(INSTALLED_RECOVERYIMAGE_TARGET): $(MKBOOTIMG) $(recovery_ramdisk) $(recovery_kernel) \
	...
	$(hide) cd $(dir $@); PYTHONDONTWRITEBYTECODE=1 $(TEGRAFLASH_PATH)/tegraflash.py --chip 0x21 --applet $(T210_PATH)/nvtboot_recovery.bin --bct P3448_A00_lpddr4_204Mhz_P987.cfg --cfg $(SIGN_PATH)/signrecovery.xml --cmd "sign"
	...
	$(hide) cd $(dir $@); PYTHONDONTWRITEBYTECODE=1 $(TEGRAFLASH_PATH)/tegraflash.py --chip 0x21 --applet $(T210_PATH)/nvtboot_recovery.bin --bct P3448_A00_lpddr4_204Mhz_P987.cfg --cfg $(SIGN_PATH)/signbatuu.xml --cmd "sign"
